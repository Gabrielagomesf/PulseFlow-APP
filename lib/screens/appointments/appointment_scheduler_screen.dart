...
class AppointmentSchedulerScreen extends StatelessWidget {
                ...
                () => SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildUpcomingAppointments(controller),
                    ],
                  ),
                ),
              ),
  ...
  Widget _buildUpcomingAppointments(AppointmentSchedulerController controller) {
    final appointments = controller.upcomingAppointments;
    if (appointments.isEmpty) {
      return _buildEmptyState(
        icon: Icons.event_busy,
        message: 'Você ainda não possui consultas agendadas.',
      );
    }
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.schedule_rounded, color: Color(0xFF00324A)),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
